...
describe("HtmlExport", function () {
  var htmlExport = new _index.HtmlExportPlugin();
  ...
  it("can export Argdown", function () {
    ...
    var result = app.run(request); //console.log(result.html);
  ...
  it("can export the argdown intro", function () {
    var source = _fs.default.readFileSync("./test/intro.argdown", "utf8");
  ...
  it("can create class names for tags", function () {
    ...
    (0, _chai.expect)(result.statements).to.exist;
...
//# sourceMappingURL=HtmlExportPlugin.spec.js.map