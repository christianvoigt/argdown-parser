...
export declare const tokensToString: (tokens: import("../node_modules/chevrotain/lib/chevrotain").IToken[]) => string;
export declare const tokenLocationsToString: (tokens: import("../node_modules/chevrotain/lib/chevrotain").IToken[]) => string;
